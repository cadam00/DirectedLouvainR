...
class Graph {
    ...
    public:
        ...
        Graph(string filename, bool renumbering=true, bool verbose=false);
        ...
        Graph(vector<vector<pair<unsigned int, double> > >, bool renumbering=true, bool verbose=false, bool weighted=true);
        ...
        Graph(vector<vector<unsigned int > >, bool renumbering=true, bool verbose=false, bool weighted=false);
